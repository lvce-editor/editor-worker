...
export const name = 'editor.title-bar-selection-move-line-down'
...
export const test: Test = async ({ ContextMenu, Editor, FileSystem, Main, TitleBarMenuBar, Workspace }) => {
  ...
  await selectTitleBarSelectionItem(TitleBarMenuBar, ContextMenu, 'Move Line Down')

  await Editor.shouldHaveText(`line 2\nline 1\nline 3`)
