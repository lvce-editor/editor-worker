...
test('getFindWidgetReplaceVirtualDom', () => {
  ...
  expect(dom).toEqual([
    { childCount: 2, className: 'FindWidgetReplace', type: 4 },
    { childCount: 2, className: 'SearchField', role: 'none', type: 4 },
    {
      autocapitalize: 'off',
      autocorrect: 'off',
      childCount: 0,
    ...
    { childCount: 0, className: 'SearchFieldButtons', type: 4 },
    {
      ariaLabel: 'Focus Previous',
      childCount: 1,
    ...
    { childCount: 0, className: 'MaskIcon MaskIconArrowUp', role: 'none', type: 4 },
  ])
})
