import * as EditorGetPositionRight from '../EditorCommand/EditorCommandGetPositionRight.ts'
import * as GetSelectionPairs from '../GetSelectionPairs/GetSelectionPairs.ts'

export const getNewSelectionsWordRight = (selections: any, lines: readonly string[], getDelta: any) => {
