export const CodeGeneratorInput = 'CodeGeneratorInput InputBox'
export const CodeGeneratorMessage = 'CodeGeneratorMessage'
export const CodeGeneratorWidget = 'Viewlet CodeGeneratorWidget'
...
export const Editor = 'Viewlet Editor'
export const EditorMessage = 'Viewlet EditorMessage EditorMessageText EditorOverlayMessage'
...
export const EditorHoverDiagnosticOnly = 'EditorHoverDiagnosticOnly'
export const EditorLineDecoration = 'EditorLineDecoration'
...
export const HoverProblem = 'HoverDisplayString HoverProblem'
...
export const SelectionUnfocused = 'EditorSelection SelectionUnfocused'
export const SourceActionHeading = 'SourceActionHeading'
export const SourceActionIcon = 'SourceActionIcon MaskIcon MaskIconSymbolFile'
export const SourceActionItem = 'SourceActionItem'
export const SourceActionItemFocused = 'SourceActionItem SourceActionItemFocused'
export const TextEditorErrorIcon = 'EditorTextIcon EditorTextIconError MaskIcon MaskIconError'
export const TextEditorError = 'Viewlet TextEditorError'
