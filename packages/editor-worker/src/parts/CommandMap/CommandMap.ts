...
export const commandMap = {
  ...
  'Editor.create': wrapCommand(CreateEditor.createEditor),
  ...
  'Editor.getKeyBindings': wrapCommand(GetKeyBindings.getKeyBindings),
  'Editor.getKeys': wrapCommand(GetKeys.getKeys),
  ...
  'Editor.getQuickPickMenuEntries': wrapCommand(GetQuickPickMenuEntries.getQuickPickMenuEntries),
  'Editor.getSelections': wrapCommand(GetSelections.getSelections),
  ...
  'Editor.getText': wrapCommand(GetText.getText),
  'Editor.getUri': ExternalGetPositionAtCursor.getUri,
  'Editor.getWordAt': wrapCommand(GetWordAt.getWordAt),
  ...
  'Editor.getWordBefore': wrapCommand(GetWordAt.getWordBefore),
  ...
  'Editor.offsetAt': wrapCommand(TextDocument.offsetAt),
  ...
  'Editor.render': wrapCommand(RenderEditor.renderEditor),
  'Editor.renderEventListeners': wrapCommand(RenderEventListeners.renderEventListeners),
  ...
  'Editor.updateDebugInfo': wrapCommand(UpdateDebugInfo.updateDebugInfo),
