...
export const commandMap = {
  ...
  'Editor.handlePointerDown': wrapCommand(handlePointerDown),
  'Editor.handlePointerMove': wrapCommand(HandlePointerMove.handlePointerMove),
  'Editor.handlePointerUp': wrapCommand(HandlePointerUp.handlePointerUp),
