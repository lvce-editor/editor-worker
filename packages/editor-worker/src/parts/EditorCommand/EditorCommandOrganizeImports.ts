...
import * as ToPositionBasedEdits from '../ToPositionBasedEdits/ToPositionBasedEdits.ts'
...
export const organizeImports = async (editor: any): Promise<any> => {
  ...
  return ApplyDocumentEdits.applyDocumentEdits(editor, positionBasedEdits)
}
